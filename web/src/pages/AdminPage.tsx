...
function CreateInvite() {
  ...
  const onCopy = () => {
    if (state.inviteLink) {
      ...
      message.success("Invite Link Copied", .5)
    }
  }
    ...
    <>
      <Input.Group>
        <Input
          ...
          {!state.inviteLink && !state.isLoading &&
      ...
      <div style={{paddingTop:'5px'}}>
        <Typography.Text type="secondary"><InfoCircleOutlined/> Invite links expire after 24 Hours</Typography.Text>
      </div>
  </>
