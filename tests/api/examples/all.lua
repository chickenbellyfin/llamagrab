...
ServerSettings.ShrikeEjectionSeat = true
...
ServerSettings.SkiingEnabled = false
ServerSettings.UseGOTYShieldPack = true
ServerSettings.InventoryStationsRestoreEnergy = true
ServerSettings.FriendlyFireDamageKickLimit = 455
ServerSettings.FriendlyFireKillKickLimit = 456
ServerSettings.BaseDestructionKickLimit = 457
ServerSettings.BaseAssets = true
ServerSettings.PoweredDeployables = false
ServerSettings.GeneratorRegen = true
ServerSettings.GeneratorDestroyable = false
ServerSettings.BaseAssetFriendlyFire = false
ServerSettings.DeployableFriendlyFire = true
ServerSettings.AoESizeMultiplier = 1.34
ServerSettings.AoEDamageMultiplier = 1.35
